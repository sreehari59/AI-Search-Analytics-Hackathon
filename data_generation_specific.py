...
PROMPT_INSTRUCTION = (
    "Generate a realistic 2025 car-related question that includes a specific, varied brand or model (e.g., Ford Focus, Rivian R1T, Dacia Spring), covering specs, performance, or comparisons, with a natural tone."
)

# FILE SETUP
chats_path = "chats_specific.csv"
actions_path = "actions_specific.csv"
